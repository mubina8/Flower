...
namespace FlowerBouquet.Controllers
{
    public class CartsController : Controller
    {
        ...
        {
            var carts = db.Carts.Include(c => c.products);
        ...
        public ActionResult Create([Bind(Include = "cartID,productId,quantity,price,createdDate")] Cart cart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "cartID,productId,quantity,price,createdDate")] Cart cart)
        {
            if (ModelState.IsValid)
            {
